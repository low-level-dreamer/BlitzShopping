-- This is our DDL file that contains our Data Definition Queries

-- Query to create our Customers table
...
-- Query to create our Logistics table
...
-- Query to create our Products table
...
-- Query to create our Sales table
...
-- Query to create our SalesProducts table
...
-- Query to insert sample data in our Customers table
...
-- Query to insert sample data in our Logistics table
...
-- Query to insert sample data in our Products table
...
-- Query to insert sample data in our Sales table
INSERT INTO Sales (customerID, address, country, dateOfSale, courierName, orderAmount, orderStatus) VALUES 
...
-- Query to insert sample data in our SalesProducts table
