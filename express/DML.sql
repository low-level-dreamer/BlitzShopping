-- This is our DML code that contains our Data Manipulation Queries
...
-- Search for a shipping method by name
SELECT * FROM Logistics
...
-- Uppdate salesproducts quantity using email,orderNumber and SKU
...
DELETE FROM SalesProducts WHERE salesID@orderNumberInput AND sku=@skuInput;
